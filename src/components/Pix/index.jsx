...
import logoCafe from '../../img/logoCafe.svg';
...
const Pix = () => {
  ...
  return (
    <div id="pixSmall" className="grid grid-flow-row m-2 lg:hidden">
      <div className="mx-2">
      ...
      <div>
        ...
        >
          ...
          <svg
            ...
            height="28"
            className={` ${
              buttonText == true ? 'hidden' : 'inline-block'
          ...
          <svg
            ...
            fill="currentColor"
            className={` ${
              buttonTextCp == false ? 'hidden' : 'inline-block'
            } bi bi-check-circle ml-2 `}
            viewBox="0 0 18 18"
          >
